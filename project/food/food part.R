...
yelp_client_ID = Sys.getenv("b1mvtJ6NN1Yr3llYIn0jkw")
yelp_key = Sys.getenv("jDwHiw2npYP2mjdD0vmcJW_PG3RDz7eA6gmLdPGWAObdQ_G2kBG4-5GE_VMpyCSRT_oWXdHV3u9HDwSPbL4qSDl9pnkgdFrD3ZASmcIB4NlUY320H-0jXtfGaOhdXnYx")
#---------------------------------------------------------------------------------------------------------
